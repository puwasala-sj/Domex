...
<div class="wrapper">
    ...
    -->
    	...
    	<div class="sidebar-wrapper">
            <div class="logo">
                <a href="Admin.jsp" class="simple-text">
                    ADMIN
                </a>
            </div>
            ...
            <ul class="nav">
                ...
                <li>
                    <a href="CashList.jsp">
						...
						<tr>
						<br><br>
				<td colspan="2"><input type="submit" value="List Cash Payments" class="list-button" />
						</td>
						</tr>
						</table>
						</form>
                ...
                <li>
                    <a href="ChequeList.jsp">
                        <i class="pe-7s-note2"></i>
                        <form method="POST" action="ListChequePaymentServlet">
						<table>
						<tr>
						<br><br>
				<td colspan="2"><input type="submit" value="List Cheque Payments" class="list-button" />
						</td>
						</tr>
						</table>
						</form>
                 ...
                 <li>
                    <a href="CardList.jsp">
                        <i class="pe-7s-note2"></i>
                        <form method="POST" action="ListCardPaymentServlet">
						<table>
						<tr>
						<br><br>
				<td colspan="2"><input type="submit" value="List Card Payments" class="list-button" />
						</td>
						</tr>
						</table>
						</form>
                ...
                <li>
                    <a href="EmployeeList.jsp">
                        <i class="pe-7s-note2"></i>
                        <form method="POST" action="ListEmployeeServlets">
						<table>
						<tr>
						<br><br>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card ">
                            <div class="header">
                                <h4 class="title">2018 Income</h4>
                                <p class="category">All including Taxes</p>
                            </div>
                            <div class="content">
